		...
		<div className="p-12 lg:pl-24 flex justify-start items-center text-sky-white lg:mt-0 h-fit w-full lg:h-screen">
			...
			>
				...
				<div className="flex flex-col items-start text-center gap-4 lg:gap-10">
					...
					<h4 className="font-montserrat font-normal text-left text-lg md:2xl max-w-[600px]">I've spent the last two and half years helping business owners and companies build and manage websites for their business. Let's connect!</h4>
